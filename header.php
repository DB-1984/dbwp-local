      ...
      <nav id="navbar_top" class="navbar navbar-expand-lg">
        <div class="container top-menu">
          ...
          <div class="collapse navbar-collapse"  id="main_nav">
             ...
             <li class="nav-item"><a class="nav-link <?php if(is_single() || is_home() && !is_front_page()) : echo "active-link"; endif;?>" href="<?php echo site_url('/blog'); ?>"><span class="plugin-span">Blog</span></a></li>
