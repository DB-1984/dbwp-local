...
/* harmony import */ var _modules_toggler_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/toggler.js */ "./src/modules/toggler.js");
/* harmony import */ var _modules_stickyHeader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/stickyHeader */ "./src/modules/stickyHeader.js");
/* harmony import */ var _modules_searchOverlay__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/searchOverlay */ "./src/modules/searchOverlay.js");
/* harmony import */ var _modules_ajaxSearch__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/ajaxSearch */ "./src/modules/ajaxSearch.js");
/* harmony import */ var _modules_ajaxSearch__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_ajaxSearch__WEBPACK_IMPORTED_MODULE_6__);
 // scss for gulp
...
(0,_modules_toggler_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
(0,_modules_stickyHeader__WEBPACK_IMPORTED_MODULE_4__["default"])();
aos__WEBPACK_IMPORTED_MODULE_1___default().init();
(0,_modules_searchOverlay__WEBPACK_IMPORTED_MODULE_5__["default"])();
_modules_ajaxSearch__WEBPACK_IMPORTED_MODULE_6___default()();
...
function ajaxSearch() {
  ...
  searchField.addEventListener('keyup', function () {
    ...
    typingTimer = setTimeout(function () {
      ...
      // Set the request method to POST and the URL to the REST API endpoint
      xhr.open('POST', '/wp-json/wp/v2/posts', true);

      // Set the Content-Type header to application/x-www-form-urlencoded
      xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');

      // Set up the request body data
      var data = 'search=' + searchQuery;
...
function searchOverlay() {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("keyup", function (e) {
      if (overlay.classList.contains("mk-fullscreen-search-overlay-show") && e.key === "Escape") {
        overlay.classList.remove("mk-fullscreen-search-overlay-show");
      }
    });
  });
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (searchOverlay);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkdbwp"] = globalThis["webpackChunkdbwp"] || [];
