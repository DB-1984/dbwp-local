...
<div class="jumbotron jumbotron-fluid" style="padding-top:160px">
  <div class="container">
    <div class="row">
      <div class="col-md-6 cover" data-aos="fade-right">
        ...
        <a href="#"><button type="button" class="btn btn-primary px-4 mx-auto cta"><p>Get In Touch</p></button></a>      </div>
      <div class="col-md-6 d-flex align-items-center justify-content-center justify-content-md-start" data-aos="fade-left">
