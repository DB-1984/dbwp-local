  ...
  <div class="container usp text-center">
    <div class="row">
      <div class="col-sm-6 col-md-6 col-lg-6">
        <div class="card">
          <div class="card-body">
          <h5 class="usp-title">Step One - Reach out!</h5>
            <p class="card-text">Get in touch using our contact form, and <span class="text-highlight">let us know what we can help you with</span>.</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-6 col-lg-6">
